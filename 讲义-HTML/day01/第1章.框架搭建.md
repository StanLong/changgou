...
![](image\Snipaste_2019-09-05_14-35-42.png)
...
资源中的虚拟机进行安装（相关的docker容器安装已经安装完毕,注意号段改为200）
...
**_注意：@MapperScan是tk.mybatis.spring.annotation包下的，用于扫描Mapper接口_** 
...
（1）在`changgou_service_goods_api`创建`com.changgou.goods.pojo`包，包下创建Brand实体类
```java
@Table(name="tb_brand")
