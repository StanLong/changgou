...
export default {
  ...
  methods: {
    ...
    batchDeleteRelation(val) {
      ...
      this.$http({
        url: this.$http.adornUrl("/product/attrattrgrouprelation/batch/delete"),
        method: "post",
    ...
    submitAddRealtion() {
      ...
      if (this.innerdataListSelections.length > 0) {
        ...
        this.$http({
          url: this.$http.adornUrl("/product/attrattrgrouprelation/batch/save"),
          method: "post",
          data: this.$http.adornData(postData, false)
        }).then(({ data }) => {
          if (data.code == 0) {
    ...
    init(id) {
      ...
      this.$http({
        url: this.$http.adornUrl(
          "/product/attrgroup/" + this.attrGroupId + "/relation/attr"
        ),
        method: "get",
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl(
          "/product/attrgroup/" + this.attrGroupId + "/no/relation/attr"
        ),
        method: "get",
        params: this.$http.adornParams({
          page: this.pageIndex,
